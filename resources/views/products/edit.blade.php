        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-sm p-6 sticky top-5">
                    ...
                    <div class="space-y-3">
                        <button type="submit"
                            class="w-full py-3 rounded-xl bg-slate-900 text-white text-sm font-semibold hover:bg-slate-800 transition">Update
                            Produk</button>
...
<script>
    let specIndex = @json($product->specifications->count());
    let supplierIndex = @json($product->suppliers->count());
