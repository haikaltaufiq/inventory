...
@section('content')
    <div class="px-5">
        <div class="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Laporan Stok Pemodal Owner</h1>
                <p class="mt-1 text-sm text-slate-500">
                    Menampilkan stok dari pemodal dengan peran owner. Stock awal dihitung dari stok ready saat ini ditambah
                    qty
                    yang sudah terjual, jadi nilainya tetap merekam qty awal masuk barang.
                </p>
            </div>
        </div>
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-5">
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm">
                ...
                <h3 class="mt-1 text-2xl font-semibold text-slate-900">Rp
                    {{ number_format($summary['total_modal'], 0, ',', '.') }}</h3>
            </div>
        </div>
