                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-3" x-data="{ mode: '{{ $midtrans['env'] ?? 'sandbox' }}' }">
                            <button type="button" @click="mode = 'production'"
                                :class="mode === 'production' ? 'bg-slate-900 text-white' :
                                    'bg-slate-100 text-slate-600 hover:bg-slate-200'"
                                class="px-4 py-2 rounded-xl text-sm font-medium transition">
                                Production
                            </button>
                            <button type="button" @click="mode = 'sandbox'"
                                :class="mode === 'sandbox' ? 'bg-slate-900 text-white' :
                                    'bg-slate-100 text-slate-600 hover:bg-slate-200'"
                                class="px-4 py-2 rounded-xl text-sm font-medium transition">
                                Sandbox
                            </button>
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input :type="show ? 'text' : 'password'" name="midtrans_server_key"
                                value="{{ $midtrans['server_key'] ?? '' }}" placeholder="SB-Mid-server-xxxxxxxxxxxx"
                    ...
                    <div>
                        ...
                        <input type="text" name="midtrans_client_key" value="{{ $midtrans['client_key'] ?? '' }}"
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">
                            ...
                            <span class="ml-2 text-xs text-slate-400 font-normal">(Daftarkan URL ini di dashboard
                                Midtrans)</span>
                        </label>
                        <div class="relative">
                            <input type="text" value="{{ url('/api/midtrans/webhook') }}" readonly id="webhookUrl"
                        ...
                        <p class="text-xs text-slate-500 mt-2">
                            Masuk ke <a href="https://dashboard.midtrans.com" target="_blank"
                                class="text-blue-500 hover:underline">dashboard.midtrans.com</a>
